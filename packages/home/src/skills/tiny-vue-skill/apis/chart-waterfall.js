export default{mode:['pc'],apis:[{name:'chart-waterfall',type:'component',options:[{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'图表主题'},mode:['pc'],pcDemo:''},{name:'legend',type:'object',defaultValue:'-',typeAnchorName:'Legend',desc:{'zh-CN':'图例配置, 默认显示'},mode:['pc'],pcDemo:''},{name:'xAxis',type:'string | object',defaultValue:'图表数据data数据中data[0]对象的第一个key值',typeAnchorName:'XAxis',desc:{'zh-CN':'配置x轴'},mode:['pc'],pcDemo:''},{name:'yAxis',type:'string | object',defaultValue:'默认显示',typeAnchorName:'YAxis',desc:{'zh-CN':'配置y轴'},mode:['pc'],pcDemo:''},{name:'padding',type:'array',defaultValue:'[50,20,50,20]',typeAnchorName:'Padding',desc:{'zh-CN':'图表内边距值'},mode:['pc'],pcDemo:''},{name:'color',type:'array',defaultValue:'-',typeAnchorName:'Color',desc:{'zh-CN':'颜色'},mode:['pc'],pcDemo:''},{name:'tooltip',type:'object',defaultValue:'默认显示',typeAnchorName:'Tooltip',desc:{'zh-CN':'悬浮提示框内容配置'},mode:['pc'],pcDemo:''},{name:'dataZoom',type:'object',defaultValue:'默认不显示',typeAnchorName:'DataZoom',desc:{'zh-CN':'区域缩放轴配置'},mode:['pc'],pcDemo:''},{name:'dataRules',type:'object',defaultValue:'-',typeAnchorName:'DataRules',desc:{'zh-CN':'数据规则'},mode:['pc'],pcDemo:''},{name:'event',type:'object',defaultValue:'默认不触发',typeAnchorName:'Event',desc:{'zh-CN':'图表事件'},mode:['pc'],pcDemo:''},{name:'data',type:'array',defaultValue:'-',typeAnchorName:'Data',desc:{'zh-CN':'图表数据(必填)'},mode:['pc'],pcDemo:''},{name:'type',type:'string',defaultValue:'-',typeAnchorName:'Type',desc:{'zh-CN':'配置柱状图类型'},mode:['pc'],pcDemo:''},{name:'topTipHtml',type:'function',defaultValue:'默认不显示',typeAnchorName:'TopTipHtml',desc:{'zh-CN':'顶部位置悬浮提示框'},mode:['pc'],pcDemo:''},{name:'itemStyle',type:'object',defaultValue:'{barWidth: 8,barGap: \'60%\'}',typeAnchorName:'ItemStyle',desc:{'zh-CN':'柱体样式'},mode:['pc'],pcDemo:''},{name:'direction',type:'string',defaultValue:'-',typeAnchorName:'Direction',desc:{'zh-CN':'柱体方向'},mode:['pc'],pcDemo:''},{name:'label',type:'object | array',defaultValue:'默认不显示',typeAnchorName:'Label',desc:{'zh-CN':'柱体文本'},mode:['pc'],pcDemo:''},{name:'lineDataName',type:'string',typeAnchorName:'LineDataName',defaultValue:'-',desc:{'zh-CN':'柱状图更改为折线图的数据名'},mode:['pc'],pcDemo:''},{name:'markline',type:'object',typeAnchorName:'Markline',defaultValue:'-',desc:{'zh-CN':'阈值线配置'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'Data',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'Direction',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>vertical</code>（垂直）</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'LineDataName',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：需要转换为折线图的数据名称<br><br>
...
</p></div></div></div></div></td></tr></div>`},{name:'TopTipHtml',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
...
</div></div></div></td></tr></div>`},{name:'Theme',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>light</code></p>
...
</p></div></div></div></div></td></tr></div>`},{name:'YAxis',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'DataZoom',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'DataRules',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：根据data数据设置data规则</p>
<p data-v-md-line="3">格式：</p>
