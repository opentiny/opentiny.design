export default{mode:['pc'],apis:[{name:'chart-pie',type:'component',options:[{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'图表主题'},mode:['pc'],pcDemo:''},{name:'color',type:'array',defaultValue:'-',typeAnchorName:'Color',desc:{'zh-CN':'颜色'},mode:['pc'],pcDemo:''},{name:'title',type:'object',defaultValue:'-',typeAnchorName:'Title',desc:{'zh-CN':'中心文本配置'},mode:['pc'],pcDemo:''},{name:'legend',type:'object',defaultValue:'默认显示',typeAnchorName:'Legend',desc:{'zh-CN':'图例配置'},mode:['pc'],pcDemo:''},{name:'tooltip',type:'object',defaultValue:'默认显示',typeAnchorName:'Tooltip',desc:{'zh-CN':'悬浮提示框内容配置'},mode:['pc'],pcDemo:''},{name:'event',type:'object',defaultValue:'默认不触发',typeAnchorName:'Event',desc:{'zh-CN':'图表事件'},mode:['pc'],pcDemo:''},{name:'data',type:'array',defaultValue:'-',typeAnchorName:'Data',desc:{'zh-CN':'图表数据(必填)'},mode:['pc'],pcDemo:''},{name:'type',type:'string',defaultValue:'-',typeAnchorName:'Type',desc:{'zh-CN':'圆盘图类型'},mode:['pc'],pcDemo:''},{name:'position',type:'object',defaultValue:'-',typeAnchorName:'Position',desc:{'zh-CN':'图表位置及大小'},mode:['pc'],pcDemo:''},{name:'minAngle',type:'number',defaultValue:'-',typeAnchorName:'MinAngle',desc:{'zh-CN':'最小扇区角度'},mode:['pc'],pcDemo:''},{name:'silent',type:'boolean',defaultValue:false,typeAnchorName:'Silent',desc:{'zh-CN':'是否关闭hover动效'},mode:['pc'],pcDemo:''},{name:'label',type:'object',defaultValue:'默认显示',typeAnchorName:'Label',desc:{'zh-CN':'外侧文本配置'},mode:['pc'],pcDemo:''},{name:'itemStyle',type:'object',defaultValue:'见说明',typeAnchorName:'ItemStyle',desc:{'zh-CN':'描边配置'},mode:['pc'],pcDemo:''},{name:'stillShowZeroSum',type:'boolean',defaultValue:'true',typeAnchorName:'StillShowZeroSum',desc:{'zh-CN':'是否在数据和为0的时候仍显示扇区'},mode:['pc'],pcDemo:''},{name:'selectedMode',type:'boolean',defaultValue:false,typeAnchorName:'SelectedMode',desc:{'zh-CN':'扇区选中模式配置'},mode:['pc'],pcDemo:''},{name:'roseType',type:'boolean',defaultValue:false,typeAnchorName:'RoseType',desc:{'zh-CN':'是否展示成南丁格尔图'},mode:['pc'],pcDemo:''},{name:'dataRules',type:'object',defaultValue:'-',typeAnchorName:'DataRules',desc:{'zh-CN':'某个数据设置指定颜色'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'Data',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'DataRules',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'MinAngle',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：最小的扇区角度<code>0 ~ 360</code>，用于防止某个值过小导致扇区太小影响交互。规范默认了2PX对应的最小角度，用户也可自定义最小角度。如果数据有0值，需要自行配置<code>minAngle: 0</code>，保证扇区无占比。</p>
</div></div></div></td></tr></div>`},{name:'Position',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">替代旧属性：<code>chartPosition</code></p>
...
</div></div></div></td></tr></div>`},{name:'SelectedMode',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>false</code></p>
...
</div></div></div></td></tr></div>`},{name:'StillShowZeroSum',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>true</code></p>
...
</div></div></div></td></tr></div>`},{name:'Type',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>circle</code>（圆环图）</p>
...
</div></div></div></td></tr></div>`},{name:'Direction',type:'interface',code:`默认值：vertical（垂直）

可选值：vertical（垂直） , horizontal（水平）

说明：配置柱状图的方向
`},{name:'ItemStyle',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Label',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
<div data-v-md-line="3"><div class="v-md-pre-wrapper v-md-pre-wrapper-d extra-class"><pre class="v-md-hljs-d"><code>label:{
    show:<span class="hljs-literal">true</span>,
    type:<span class="hljs-string">'percent'</span>,
    line:<span class="hljs-literal">true</span>,
...
</p></div></div></div></div></td></tr></div>`},{name:'LineDataName',type:'interface',code:`说明：需要转换为折线图的数据名称<br>
折柱混合图是建立在 barChart 的基础上实现的（不可颠倒），除了折线图的预测线 predict 属性，其它属性都能支持
`},{name:'Theme',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>light</code></p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Tooltip',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
...
</div ></div ></div ></td ></tr > `},{name:'Event',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'Title',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：对齐 echarts 的 <code>title</code> 属性，替代旧属性<code>text</code></p>
