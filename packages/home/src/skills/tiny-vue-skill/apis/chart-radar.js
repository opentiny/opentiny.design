export default{mode:['pc'],apis:[{name:'chart-radar',type:'component',options:[{name:'data',type:'array',defaultValue:'-',typeAnchorName:'Data',desc:{'zh-CN':'图表数据(必填)'},mode:['pc'],pcDemo:''},{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'图表主题'},mode:['pc'],pcDemo:''},{name:'color',type:'array',defaultValue:'-',typeAnchorName:'Color',desc:{'zh-CN':'颜色'},mode:['pc'],pcDemo:''},{name:'title',type:'object',defaultValue:'-',typeAnchorName:'Title',desc:{'zh-CN':'中心文本配置'},mode:['pc'],pcDemo:''},{name:'legend',type:'object',defaultValue:'默认显示',typeAnchorName:'Legend',desc:{'zh-CN':'图例配置'},mode:['pc'],pcDemo:''},{name:'tooltip',type:'object',defaultValue:'默认显示',typeAnchorName:'Tooltip',desc:{'zh-CN':'悬浮提示框内容配置'},mode:['pc'],pcDemo:''},{name:'markLine',type:'number | array',defaultValue:'默认显示',typeAnchorName:'MarkLine',desc:{'zh-CN':'阈值线配置'},mode:['pc'],pcDemo:''},{name:'radarMax',type:'number | array',defaultValue:'默认显示',typeAnchorName:'RadarMax',desc:{'zh-CN':'最外圈代表的数值'},mode:['pc'],pcDemo:''},{name:'event',type:'object',defaultValue:'默认不触发',typeAnchorName:'Event',desc:{'zh-CN':'图表事件'},mode:['pc'],pcDemo:''},{name:'position',type:'object',defaultValue:'{center:[\'50%\', \'50%\'],radius: \'50%\'}',typeAnchorName:'Position',desc:{'zh-CN':'图表位置及大小'},mode:['pc'],pcDemo:''},{name:'radarMark',type:'boolean',defaultValue:'-',typeAnchorName:'RadarMark',desc:{'zh-CN':'底部坐标系刻度值显示'},mode:['pc'],pcDemo:''},{name:'radar',type:'object',defaultValue:'-',typeAnchorName:'Radar',desc:{'zh-CN':'雷达图的坐标系配置'},mode:['pc'],pcDemo:''},{name:'area',type:'object',defaultValue:'-',typeAnchorName:'Area',desc:{'zh-CN':'雷达图图形区域配置'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'Area',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：area 用来控制用雷达图图形区域。</p>
...
</p><p class="ev_expand_introduce">说明：控制图形区域的填充是否显示。</p></div></div></div></div></td></tr></div>`},{name:'Data',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Radar',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'RadarMark',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>true</code></p>
<p data-v-md-line="3">可选值:<code>true,false</code></p>
<p data-v-md-line="5">说明：雷达图底部坐标系是否显示刻度值。</p>
</div></div></div></td></tr></div>`},{name:'RadarMax',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>雷达图坐标系的最外圈为数据中的最大值</code></p>
...
</div></div></div></div></div></td></tr></div>`},{name:'Legend',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
