export default{mode:['pc'],apis:[{name:'chart-candle',type:'component',options:[{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'主题'},mode:['pc'],pcDemo:''},{name:'color',type:'array | string',defaultValue:'随主题',typeAnchorName:'Color',desc:{'zh-CN':'图表颜色'},mode:['pc'],pcDemo:''},{name:'padding',type:'array',defaultValue:'[50,20,50,20]',typeAnchorName:'Padding',desc:{'zh-CN':'图表内边距值'},mode:['pc'],pcDemo:''},{name:'legend',type:'object',defaultValue:'默认显示',typeAnchorName:'Legend',desc:{'zh-CN':'图例配置'},mode:['pc'],pcDemo:''},{name:'dataZoom',type:'object',defaultValue:'[50,20,50,20]',typeAnchorName:'DataZoom',desc:{'zh-CN':'区域缩放轴配置'},mode:['pc'],pcDemo:''},{name:'event',type:'object',defaultValue:'默认不触发',typeAnchorName:'Event',desc:{'zh-CN':'图表事件'},mode:['pc'],pcDemo:''},{name:'MA',type:'array',defaultValue:'无',typeAnchorName:'Ma',desc:{'zh-CN':'k线图的MA数据均线'},mode:['pc'],pcDemo:''},{name:'volume',type:'boolean',defaultValue:'无',typeAnchorName:'Volume',desc:{'zh-CN':'显示volume数据'},mode:['pc'],pcDemo:''},{name:'data',type:'array',defaultValue:'无',typeAnchorName:'Data',desc:{'zh-CN':'图表数据'},mode:['pc'],pcDemo:''},{name:'upColor',type:'string',defaultValue:'错误主题色',typeAnchorName:'UpColor',desc:{'zh-CN':'上行数据颜色'},mode:['pc'],pcDemo:''},{name:'downColor',type:'string',defaultValue:'成功主题色',typeAnchorName:'DownColor',desc:{'zh-CN':'下行数据颜色'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'Data',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'DownColor',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：配置k线图的下行数据的颜色</p>
</div></div></div></td></tr></div>`},{name:'Ma',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：控制k线图的数据均线显示,数组中的数值代表你想显示的数据均线的天数，确保data中的数据包含MA中所填的数据天数<br><br>
格式：</p>
...
</div></div></div></div></div></td></tr></div>`},{name:'Padding',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：<code>padding仅在不显示的volume的时候可用!!!</code><br><br>
...
</div></div></div></td></tr></div>`},{name:'UpColor',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：配置k线图的上行数据的颜色</p>
</div></div></div></td></tr></div>`},{name:'Volume',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：控制图表中是否显示volume数据<code>如需使用这个功能，图表data中需要配置volume字段</code></p>
