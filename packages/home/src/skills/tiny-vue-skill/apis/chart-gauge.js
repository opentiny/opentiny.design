export default{mode:['pc'],apis:[{name:'chart-gauge',type:'component',options:[{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'图表主题'},mode:['pc'],pcDemo:''},{name:'color',type:'array | string',defaultValue:'-',typeAnchorName:'Color',desc:{'zh-CN':'颜色'},mode:['pc'],pcDemo:''},{name:'tooltip',type:'object',defaultValue:'默认显示',typeAnchorName:'Tooltip',desc:{'zh-CN':'悬浮提示框内容配置'},mode:['pc'],pcDemo:''},{name:'event',type:'object',defaultValue:'默认不触发',typeAnchorName:'Event',desc:{'zh-CN':'图表事件'},mode:['pc'],pcDemo:''},{name:'data',type:'array',defaultValue:'[ value: 90, name: \'Utilization rate\' ]',typeAnchorName:'Data',desc:{'zh-CN':'图表数据(必填)'},mode:['pc'],pcDemo:''},{name:'position',type:'object',defaultValue:'{center:[\'50%\', \'50%\'],radius: \'70%\'}',typeAnchorName:'Position',desc:{'zh-CN':'图表位置及大小'},mode:['pc'],pcDemo:''},{name:'pointer',type:'boolean',defaultValue:'false',typeAnchorName:'Pointer',desc:{'zh-CN':'刻度指针是否显示'},mode:['pc'],pcDemo:''},{name:'min',type:'number',defaultValue:'0',typeAnchorName:'Min',desc:{'zh-CN':'刻度盘最小刻度'},mode:['pc'],pcDemo:''},{name:'max',type:'number',defaultValue:'100',typeAnchorName:'Max',desc:{'zh-CN':'刻度盘最大刻度'},mode:['pc'],pcDemo:''},{name:'text',type:'object',defaultValue:'默认居中',typeAnchorName:'Text',desc:{'zh-CN':'中心文本配置'},mode:['pc'],pcDemo:''},{name:'startAngle',type:'number',defaultValue:'225',typeAnchorName:'StartAngle',desc:{'zh-CN':'仪表盘起始角度'},mode:['pc'],pcDemo:''},{name:'endAngle',type:'number',defaultValue:'-45',typeAnchorName:'EndAngle',desc:{'zh-CN':'仪表盘结束角度'},mode:['pc'],pcDemo:''},{name:'splitColor',type:'array',defaultValue:'随主题',typeAnchorName:'SplitColor',desc:{'zh-CN':'配置分割区间及颜色'},mode:['pc'],pcDemo:''},{name:'splitNumber',type:'number',defaultValue:'4',typeAnchorName:'SplitNumber',desc:{'zh-CN':'刻度线数量配置'},mode:['pc'],pcDemo:''},{name:'splitLine',type:'object',defaultValue:'默认显示',typeAnchorName:'SplitLine',desc:{'zh-CN':'刻度线及文本配置'},mode:['pc'],pcDemo:''},{name:'markLine',type:'number',defaultValue:'无',typeAnchorName:'MarkLine',desc:{'zh-CN':'阈值线配置'},mode:['pc'],pcDemo:''},{name:'gradientColor',type:'array',defaultValue:'无',typeAnchorName:'GradientColor',desc:{'zh-CN':'线性渐变'},mode:['pc'],pcDemo:''},{name:'itemStyle',type:'object',defaultValue:'见详情',typeAnchorName:'ItemStyle',desc:{'zh-CN':'进度条样式配置'},mode:['pc'],pcDemo:''},{name:'axisLabelStyle',type:'object',defaultValue:'见详情',typeAnchorName:'AxisLabelStyle',desc:{'zh-CN':'刻度线文本样式配置'},mode:['pc'],pcDemo:''},{name:'pointerStyle',type:'object',defaultValue:'见详情',typeAnchorName:'PointerStyle',desc:{'zh-CN':'调整指针样式'},mode:['pc'],pcDemo:''},{name:'mask',type:'object',defaultValue:'{show: false, highLight: true}',typeAnchorName:'Mask',desc:{'zh-CN':'外层光晕蒙层配置'},mode:['pc'],pcDemo:''},{name:'orbitalColor',type:'string',defaultValue:'随主题',typeAnchorName:'OrbitalColor',desc:{'zh-CN':'仪表盘的轨道颜色'},mode:['pc'],pcDemo:''},{name:'silent',type:'boolean',defaultValue:'false',typeAnchorName:'Silent',desc:{'zh-CN':'是否关闭hover动效'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'AxisLabelStyle',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：用于调整刻度文本的样式。</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Data',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式:<code>[value:90, name:'Utilization rate']</code></p>
<p data-v-md-line="3">说明：图表数据，value 为仪表盘的刻度,name 为数据名称。</p>
</div></div></div></td></tr></div>`},{name:'EndAngle',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>-45</code></p>
<p data-v-md-line="3">说明：仪表盘结束角度。圆心正右手侧为 0 度，正上方为 90 度，正左手侧为 180 度</p>
</div></div></div></td></tr></div>`},{name:'GradientColor',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：[<br>
...
</p></div></div></div></div></td></tr></div>`},{name:'MarkLine',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：设置阈值线，超出阈值时，进度条会变成warning色</p>
</div></div></div></td></tr></div>`},{name:'Mask',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>{show:false,hightLight:true}</code></p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Max',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>100</code></p>
<p data-v-md-line="3">说明：仪表盘的最大值</p>
</div></div></div></td></tr></div>`},{name:'Min',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>0</code></p>
<p data-v-md-line="3">说明：仪表盘的最小值</p>
</div></div></div></td></tr></div>`},{name:'OrbitalColor',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：用来控制仪表盘的轨道颜色</p>
</div></div></div></td></tr></div>`},{name:'Pointer',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>false</code></p>
<p data-v-md-line="3">可选值：<code>true, false</code></p>
<p data-v-md-line="5">说明：仪表盘的刻度指针是否显示</p>
</div></div></div></td></tr></div>`},{name:'PointerStyle',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Position',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">替代旧属性：<code>chartPosition</code></p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Slient',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>false</code></p>
<p data-v-md-line="3">说明：是否关闭 hover 态的效果</p>
</div></div></div></td></tr></div>`},{name:'SplitColor',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式:</p>
...
</div></div></div></td></tr></div>`},{name:'SplitLine',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：控制刻度线及刻度文本是否显示</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'SplitNumber',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>4</code></p>
<p data-v-md-line="3">说明：整个仪表盘被分成的份数，splitNumber = n 时表示被分成了 n 份，有 n+1 条刻度线</p>
</div></div></div></td></tr></div>`},{name:'StartAngle',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>225</code></p>
<p data-v-md-line="3">说明：仪表盘起始角度。圆心正右手侧为 0 度，正上方为 90 度，正左手侧为 180 度</p>
</div></div></div></td></tr></div>`},{name:'Text',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值:显示 data 中的 value 和 name 值</p>
...
</p></div></div></div></div></td></tr></div>`},{name:'Theme',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>light</code></p>
...
</div ></div ></div ></td></tr></div>`},{name:'Event',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'Silent',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>false</code></p>
<p data-v-md-line="3">说明：是否关闭 hover 态的效果</p>
