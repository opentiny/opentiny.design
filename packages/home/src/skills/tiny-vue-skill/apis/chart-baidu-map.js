export default{mode:['pc'],apis:[{name:'chart-baidu-map',type:'component',options:[{name:'key',type:'string',defaultValue:'无',typeAnchorName:'Key',desc:{'zh-CN':'百度地图秘钥'},mode:['pc'],pcDemo:''},{name:'url',type:'string',defaultValue:'见详情',typeAnchorName:'Url',desc:{'zh-CN':'百度地图前缀地址'},mode:['pc'],pcDemo:''},{name:'v',type:'string',defaultValue:'1.4.3',typeAnchorName:'V',desc:{'zh-CN':'百度地图版本'},mode:['pc'],pcDemo:''},{name:'bmap',type:'object',defaultValue:'见详情',typeAnchorName:'BMap',desc:{'zh-CN':'百度地图配置项'},mode:['pc'],pcDemo:''},{name:'series',type:'object',defaultValue:'见详情',typeAnchorName:'Series',desc:{'zh-CN':'百度地图插件配置项'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'BMap',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式示例：</p>
...
<code>mapStyle</code>：百度地图的自定义样式。<br><br>
其他更多属性配置可见Echarts百度地图扩展的git网址：<a href="https://github.com/apache/echarts/tree/release/extension-src/bmap" target="_blank">https://github.com/apache/echarts/tree/release/extension-src/bmap</a>。</p>
</div></div></div></td></tr></div>`},{name:'V',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：通过配置<code>v</code>属性，修改百度地图api的版本号，默认2.0。<br></p>
</div></div></div></td></tr></div>`},{name:'Url',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：通过配置<code>url</code>属性，修改百度地图api的前缀地址。<br></p>
