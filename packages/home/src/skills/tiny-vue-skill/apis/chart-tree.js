export default{mode:['pc'],apis:[{name:'chart-tree',type:'component',options:[{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'主题'},mode:['pc'],pcDemo:''},{name:'padding',type:'array',defaultValue:'[50,20,50,20]',typeAnchorName:'Padding',desc:{'zh-CN':'图表内边距值'},mode:['pc'],pcDemo:''},{name:'tooltip',type:'object',defaultValue:'默认显示',typeAnchorName:'Tooltip',desc:{'zh-CN':'悬浮提示框内容配置'},mode:['pc'],pcDemo:''},{name:'data',type:'array',defaultValue:'无',typeAnchorName:'Data',desc:{'zh-CN':'图表数据'},mode:['pc'],pcDemo:''},{name:'type',type:'string',defaultValue:'无',typeAnchorName:'Type',desc:{'zh-CN':'树图类型'},mode:['pc'],pcDemo:''},{name:'direction',type:'string',defaultValue:'left',typeAnchorName:'Direction',desc:{'zh-CN':'线性树图起点方向'},mode:['pc'],pcDemo:''},{name:'symbolSize',type:'number',defaultValue:'10',typeAnchorName:'SymbolSize',desc:{'zh-CN':'树图图元大小'},mode:['pc'],pcDemo:''},{name:'lineType',type:'string',defaultValue:'curve',typeAnchorName:'LineType',desc:{'zh-CN':'线性树图连线形状'},mode:['pc'],pcDemo:''},{name:'initialTreeDepth',type:'number',defaultValue:'1',typeAnchorName:'InitialTreeDepth',desc:{'zh-CN':'树图初始展开层级'},mode:['pc'],pcDemo:''}],events:[{name:'ready',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C每次渲染都会触发一次'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''},{name:'ready-once',type:'()=>void',defaultValue:'',desc:{'zh-CN':'图表渲染完成后触发\uFF0C只会在首次渲染完成后触发'},mode:['pc','mobile','mobile-first'],pcDemo:'',mfDemo:''}],methods:[],slots:[{name:'default',type:'',defaultValue:'',desc:{'zh-CN':'组件默认插槽'},mode:['pc','mobile-first'],pcDemo:'',mfDemo:''}]}],types:[{name:'Data',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'InitialTreeDepth',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>1</code></p>
<p data-v-md-line="3">说明：树图的初始展开层级,最小值为 1</p>
</div></div></div></td></tr></div>`},{name:'LineType',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>'curve'</code></p>
...
</div></div></div></td></tr></div>`},{name:'SymbolSize',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：<code>10</code></p>
