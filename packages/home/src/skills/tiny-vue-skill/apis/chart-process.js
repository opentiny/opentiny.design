export default{mode:['pc'],apis:[{name:'chart-process',type:'component',options:[{name:'theme',type:'string',defaultValue:'cloud-light',typeAnchorName:'Theme',desc:{'zh-CN':'图表主题'},mode:['pc'],pcDemo:''},{name:'color',type:'array',defaultValue:'-',typeAnchorName:'Color',desc:{'zh-CN':'颜色'},mode:['pc'],pcDemo:''},{name:'padding',type:'array',defaultValue:'[50,20,50,20]',typeAnchorName:'Padding',desc:{'zh-CN':'图表内边距值'},mode:['pc'],pcDemo:''},{name:'tooltip',type:'object',defaultValue:'默认显示',typeAnchorName:'Tooltip',desc:{'zh-CN':'悬浮提示框内容配置'},mode:['pc'],pcDemo:''},{name:'event',type:'object',defaultValue:'默认不触发',typeAnchorName:'Event',desc:{'zh-CN':'图表事件'},mode:['pc'],pcDemo:''},{name:'data',type:'array',defaultValue:'-',typeAnchorName:'Data',desc:{'zh-CN':'图表数据'},mode:['pc'],pcDemo:''},{name:'name',type:'array',defaultValue:'无',typeAnchorName:'Name',desc:{'zh-CN':'图表数据(必填)'},mode:['pc'],pcDemo:''},{name:'unit',type:'string',defaultValue:'见详情',typeAnchorName:'Unit',desc:{'zh-CN':'进度图右侧文本单位'},mode:['pc'],pcDemo:''},{name:'barWidth',type:'number',defaultValue:'见详情',typeAnchorName:'BarWidth',desc:{'zh-CN':'进度图柱形宽度'},mode:['pc'],pcDemo:''},{name:'minWidth',type:'string',defaultValue:'无',typeAnchorName:'MinWidth',desc:{'zh-CN':'进度图单项数据的最小宽度'},mode:['pc'],pcDemo:''},{name:'calibrationValue',type:'number',defaultValue:'见详情',typeAnchorName:'CalibrationValue',desc:{'zh-CN':'进度图标定值'},mode:['pc'],pcDemo:''},{name:'label',type:'object',defaultValue:'无',typeAnchorName:'Label',desc:{'zh-CN':'堆叠进度图图表图元文本样式'},mode:['pc'],pcDemo:''},{name:'state',type:'object',defaultValue:'无',typeAnchorName:'State',desc:{'zh-CN':'根据状态设置颜色'},mode:['pc'],pcDemo:''},{name:'title',type:'object',defaultValue:'无',typeAnchorName:'Title',desc:{'zh-CN':'进度图图表标题样式'},mode:['pc'],pcDemo:''},{name:'text',type:'object',defaultValue:'无',typeAnchorName:'Text',desc:{'zh-CN':'进度图图表右侧文本样式'},mode:['pc'],pcDemo:''}]}],types:[{name:'BarWidth',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：横向进度图 ProcessBarChart:<code>8</code><br>
，堆叠横向进度图 StackProcessBarChart:<code>20</code>，<br>
说明：用来控制进度图柱形宽度</p>
</div></div></div></td></tr></div>`},{name:'CalibrationValue',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：进度图：<code>100</code>，堆叠进度图：当前 data 中各项 children 的 value 总和的最大值,</p>
...
</div></div></div></td></tr></div>`},{name:'MinWidth',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：用于进度图图表解决各项数据差值过大，导致部分数据显示不明显的问题，是百分比数值，表示占据当前数据的比例，例如’2%'。</p>
</div></div></div></td></tr></div>`},{name:'Name',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">说明：图表名称，不允许自定义<br><br>
横向进度图–<code>name: 'ProcessBarChart'</code>,<br><br>
堆叠横向进度图–<code>name: 'StackProcessBarChart'</code>,<br></p>
</div></div></div></td></tr></div>`},{name:'State',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">格式：</p>
...
</div></div></div></td></tr></div>`},{name:'Unit',type:'interface',code:`<div class="tiny-huicharts"><tr class="tiny-grid-body__expanded-row"><td class="tiny-grid-body__expanded-column" colspan="5"><div class="tiny-grid-body__expanded-cell"><div class="v-md-editor-preview main-editor api-table" style="tab-size: 2;"><div class="github-markdown-body"><p data-v-md-line="1">默认值：横向进度图：<code>%</code>，堆叠横向进度图：无</p>
