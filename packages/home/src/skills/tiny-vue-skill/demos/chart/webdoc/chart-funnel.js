export default{column:'2',owner:'',demos:[{'demoId':'funnel-base','name':{'zh-CN':'基本用法','en-US':'Basic Usage'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/base.vue']},{'demoId':'funnel-demo2','name':{'zh-CN':'金字塔漏斗图','en-US':'Pyramid Funnel Chart'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo2.vue']},{'demoId':'funnel-demo3','name':{'zh-CN':'自定义映射宽度','en-US':'Custom Map Width'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo3.vue']},{'demoId':'funnel-demo4','name':{'zh-CN':'自定义大小和位置','en-US':'Custom size and position'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo4.vue']},{'demoId':'funnel-demo5','name':{'zh-CN':'自定义颜色','en-US':'Custom Colors'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo5.vue']},{'demoId':'funnel-demo6','name':{'zh-CN':'自定义 legend','en-US':'Customized Legend'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo6.vue']},{'demoId':'funnel-demo7','name':{'zh-CN':'自定义 tooltip','en-US':'Customized tooltip'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo7.vue']},{'demoId':'funnel-demo7','name':{'zh-CN':'自定义 tooltip','en-US':'Customized tooltip'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo7.vue']},{'demoId':'funnel-demo7','name':{'zh-CN':'自定义 tooltip','en-US':'Customized tooltip'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['funnel/demo7.vue']}],apis:[{'name':'chart-funnel','type':'component','props':[],'events':[],'slots':[]}],types:[{name:'IChartSettings',type:'interface',code:`
