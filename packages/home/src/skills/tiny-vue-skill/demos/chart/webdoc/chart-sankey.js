export default{column:'2',owner:'',demos:[{'demoId':'sankey-base','name':{'zh-CN':'基本用法','en-US':'Basic Usage'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['sankey/base.vue']},{'demoId':'sankey-demo2','name':{'zh-CN':'自定义鼠标悬浮提示框','en-US':'Customizing the Mouseover Prompt Box'},'desc':{'zh-CN':'详细用法参考如下示例','en-US':'For details, see the following example.'},'codeFiles':['sankey/demo2.vue']}],apis:[{'name':'chart-sankey','type':'component','props':[],'events':[],'slots':[]}],types:[{name:'IChartSettings',type:'interface',code:`
