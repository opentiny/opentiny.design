export default{column:'2',owner:'',show:true,cloud:true,demos:[{demoId:'basic-usage',name:{'zh-CN':'基本用法','en-US':'Basic Usage'},desc:{'zh-CN':`
          ...
          `},codeFiles:['basic-usage.vue']},{demoId:'props',name:{'zh-CN':'数据格式 / 禁用','en-US':'Data format/Disabled'},desc:{'zh-CN':`
          ...
          `},codeFiles:['props.vue']},{demoId:'icons',name:{'zh-CN':'自定义图标','en-US':'Custom icon'},desc:{'zh-CN':`
          ...
          `},codeFiles:['icons.vue']},{demoId:'slot',name:{'zh-CN':'自定义节点 / 插槽','en-US':'Customize nodes/slots'},desc:{'zh-CN':`
          ...
          `},codeFiles:['slot.vue']},{demoId:'node-hl',name:{'zh-CN':'节点的高亮 / 查询','en-US':'Highlighting/querying nodes'},desc:{'zh-CN':`
          ...
          `},codeFiles:['node-hl.vue']},{demoId:'expand-control',name:{'zh-CN':'节点的展开控制','en-US':'Expansion control of nodes'},desc:{'zh-CN':`
          ...
          `},codeFiles:['expand-control.vue']},{demoId:'node-op',name:{'zh-CN':'节点的增删改','en-US':'Adding, deleting or modifying nodes'},desc:{'zh-CN':`
          ...
          `},codeFiles:['node-op.vue']},{demoId:'checkbox',name:{'zh-CN':'多选模式','en-US':'Multiple choice mode'},desc:{'zh-CN':`
          ...
          `},codeFiles:['checkbox.vue']},{demoId:'check-op',name:{'zh-CN':'多选的查询 / 勾选','en-US':'Multiple-selection query/select'},desc:{'zh-CN':`
          ...
          `},codeFiles:['check-op.vue']},{demoId:'radio',name:{'zh-CN':'单选模式','en-US':'Radio mode'},desc:{'zh-CN':`
          ...
          `},codeFiles:['radio.vue']},{demoId:'filter-view',name:{'zh-CN':'节点过滤与视图','en-US':'Node filtering and views'},desc:{'zh-CN':`
          ...
          `},codeFiles:['filter-view.vue']},{demoId:'lazy',name:{'zh-CN':'懒加载','en-US':'Lazy loading'},desc:{'zh-CN':`
          ...
          `},codeFiles:['lazy.vue']},{demoId:'drag',name:{'zh-CN':'拖拽节点','en-US':'Drag node'},desc:{'zh-CN':`
          ...
          `},codeFiles:['drag.vue']},{demoId:'edit',name:{'zh-CN':'编辑节点','en-US':'Edit node'},desc:{'zh-CN':`
        ...
        `},codeFiles:['edit.vue']},{demoId:'edit-control',name:{'zh-CN':'编辑权限和事件','en-US':'Edit node'},desc:{'zh-CN':`
          ...
          `},codeFiles:['edit-control.vue']},{demoId:'contextmenu',name:{'zh-CN':'右键菜单','en-US':'Right-click menu'},desc:{'zh-CN':`
          ...
          `},codeFiles:['contextmenu.vue']},{demoId:'other',name:{'zh-CN':'其它特性','en-US':'Other characteristics'},desc:{'zh-CN':`
          ...
          `},codeFiles:['other.vue']}],features:[{id:'basic',name:'基本功能',support:{value:true},description:'支持基本的树形结构展示功能\u3002',cloud:{value:true},apis:['data'],demos:['basic-usage']},{id:'selection',name:'选择功能',support:{value:true},description:'支持单选和多选功能\u3002',cloud:{value:true},apis:['show-checkbox','multiple'],demos:['selection']},{id:'disabled',name:'禁用状态',support:{value:true},description:'支持禁用整个树或单个节点\u3002',cloud:{value:true},apis:['disabled'],demos:['disabled']},{id:'expand',name:'展开控制',support:{value:true},description:'支持控制节点的展开和收起状态\u3002',cloud:{value:true},apis:['expand-on-click-node','default-expand-all'],demos:['expand']},{id:'customization',name:'自定义内容',support:{value:true},description:'支持自定义节点内容和图标\u3002',cloud:{value:true},apis:['render-content','icon'],demos:['custom-content']}]};