export default{column:'2',owner:'',show:true,cloud:true,demos:[{demoId:'basic-usage',name:{'zh-CN':'基本用法','en-US':'Basic Usage'},desc:{'zh-CN':`
          ...
          `},codeFiles:['basic-usage.vue']},{demoId:'custom-titles',name:{'zh-CN':'自定义列表标题区','en-US':'Customized List Title'},desc:{'zh-CN':`
          ...
          `},codeFiles:['custom-titles.vue']},{demoId:'custom-btns',name:{'zh-CN':'自定义按钮区','en-US':'Display All Move Buttons'},desc:{'zh-CN':`
          ...
          `},codeFiles:['custom-btns.vue']},{demoId:'custom-footer',name:{'zh-CN':'自定义列表底部','en-US':'Custom List Bottom'},desc:{'zh-CN':'通过 <code>left-footer</code> \u3001 <code>right-footer</code> 插槽可分别对左右列表底部进行自定义\u3002\n','en-US':'The bottom of the list can be customized using the <code>left-footer</code> and <code>right-footer</code> slots, respectively. '},codeFiles:['custom-footer.vue']},{demoId:'custom-render',name:{'zh-CN':'自定义数据项显示','en-US':'Customized Data Item Rendering'},desc:{'zh-CN':`
          ...
          `},codeFiles:['custom-render.vue']},{demoId:'custom-size',name:{'zh-CN':'自定义面板大小','en-US':'Customized Panel Size'},desc:{'zh-CN':`
          ...
          `},codeFiles:['custom-size.vue']},{demoId:'custom-filter',name:{'zh-CN':'过滤搜索','en-US':'Custom Search Method'},desc:{'zh-CN':`
          ...
          `},codeFiles:['custom-filter.vue']},{demoId:'default-checked',name:{'zh-CN':'默认勾选项','en-US':'Default options'},desc:{'zh-CN':`
          ...
          `},codeFiles:['default-checked.vue']},{demoId:'drop-config',name:{'zh-CN':'可拖拽','en-US':'Drag left and right'},desc:{'zh-CN':`
          <div class="tip custom-block">
            <p class="custom-block-title">使用拖拽功能时请先安装 sortablejs 插件</p>
          </div>
          通过 <code>drop-config</code> 属性配置 sortablejs 插件进行左右拖拽穿梭。`,'en-US':`
        <div class="tip custom-block">
          <p class="custom-block-title"> Please install sortablejs plugin before using drag and drop function </p>
        </div>
        Pass The <code>drop-config</code> property config the sortablejs plugin to do the left-right drag shuttle.`},codeFiles:['drop-config.vue']},{demoId:'target-order',name:{'zh-CN':'右侧排序策略','en-US':'Right Sorting Policy'},desc:{'zh-CN':`
        通过 <code>target-order</code> 属性设置右侧列表元素的排序策略，有 original、push、unshift 三个选项，默认为 original。
          ...
          </div>`},codeFiles:['target-order.vue']},{demoId:'before-transfer',name:{'zh-CN':'穿梭拦截','en-US':'Clear the search box manually'},desc:{'zh-CN':`
          ...
          `},codeFiles:['before-transfer.vue']},{demoId:'nested-table',name:{'zh-CN':'嵌套表格','en-US':'Nested Table'},desc:{'zh-CN':`
          ...
          `},codeFiles:['nested-table.vue']},{demoId:'nested-tree',name:{'zh-CN':'嵌套树','en-US':'Nested Tree'},desc:{'zh-CN':'当 <code>render</code> 属性里的 <code>plugin</code> 设置为 <code>Tree</code> 时指定穿梭框渲染成树\uFF0C通过 <code>treeConfig</code> 属性配置树相关的配置\uFF08具体配置可参考 <code>tree</code> 组件的配置\uFF09\u3002','en-US':'When the <code>plugin</code> in the <code>render</code> attribute is set to <code>Tree</code>, you specify the shuttle to render as a tree. Configure the tree-like configuration via the <code>treeConfig</code> property (see the configuration of the <code>tree</code> component).'},codeFiles:['nested-tree.vue']},{demoId:'transfer-events',name:{'zh-CN':'穿梭框事件','en-US':'transfer Event'},desc:{'zh-CN':`
        ...
        </div>`},codeFiles:['transfer-events.vue']}],features:[{id:'basic',name:'基本用法',support:{value:true},description:'通过 data 属性提供数据源\uFF0Cvalue 属性指定右侧列表值\u3002',cloud:{value:true},apis:['data','value'],demos:['basic-usage']},{id:'custom',name:'自定义',support:{value:true},description:'支持自定义标题\u3001按钮文本\u3001列表底部等内容\u3002',cloud:{value:true},apis:['titles','button-texts','left-footer','right-footer'],demos:['custom-titles','custom-btns','custom-footer']},{id:'filter',name:'过滤搜索',support:{value:true},description:'通过 filterable 开启搜索功能\uFF0C可自定义搜索方法\u3002',cloud:{value:true},apis:['filterable','filter-method'],demos:['custom-filter']},{id:'sort',name:'排序策略',support:{value:true},description:'通过 target-order 设置右侧列表元素的排序策略\u3002',cloud:{value:true},apis:['target-order'],demos:['target-order']}]};