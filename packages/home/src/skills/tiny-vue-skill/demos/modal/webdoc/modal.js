...
`},codeFiles:['basic-usage.vue']},{demoId:'status',name:{'zh-CN':'状态和图标','en-US':'Status and ICONS'},desc:{'zh-CN':'通过<code>status</code>属性设置组件状态\uFF0C可选值有<code>info</code>\u3001<code>success</code>\u3001<code>warning</code>\u3001<code>error</code>\u3001<code>loading</code>\uFF0C每种状态有相应的状态图标\u3002','en-US':'Use the <code>status</code> property to set the component state, Optional values are <code>info</code>, <code>success</code>, <code>warning</code>, <code>error</code>, and <code>loading</code>. Each state has a corresponding status icon.'},codeFiles:['status.vue']},{demoId:'modal-header',name:{'zh-CN':'自定义弹窗标题','en-US':'Custom Modal title'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-header.vue']},{demoId:'modal-footer',name:{'zh-CN':'自定义弹窗底部','en-US':'Custom modal bottom'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-footer.vue']},{demoId:'modal-size',name:{'zh-CN':'弹窗大小/全屏','en-US':'Size control'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-size.vue']},{demoId:'modal-resize',name:{'zh-CN':'弹窗调整大小','en-US':'Size control'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-resize.vue']},{demoId:'modal-mask',name:{'zh-CN':'弹窗的遮罩层','en-US':'Modal mask'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-mask.vue']},{demoId:'modal-lock',name:{'zh-CN':'弹窗的锁定','en-US':'Modal lock'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-lock.vue']},{demoId:'modal-other',name:{'zh-CN':'弹窗的其它特性','en-US':'Other features of modal'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-other.vue']},{demoId:'modal-event',name:{'zh-CN':'弹窗的事件','en-US':'Modal event'},desc:{'zh-CN':`
          ...
          `},codeFiles:['modal-event.vue']},{demoId:'modal-fn-slots',name:{'zh-CN':'弹窗的插槽','en-US':'Modal slots'},desc:{'zh-CN':`
        ...
        `},codeFiles:['modal-fn-slots.vue']},{demoId:'message-close',name:{'zh-CN':'消息的关闭和延时','en-US':'Closure and delay of messages'},desc:{'zh-CN':`
        ...
        `},codeFiles:['message-close.vue']},{demoId:'message-top',name:{'zh-CN':'消息距离顶部位置','en-US':'Position from top'},desc:{'zh-CN':'通过<code>top</code>属性设置消息距离顶部的位置\uFF0C单位为 px','en-US':`Use the <code>top</code> property to set the distance from the top of the message in units of px. `},codeFiles:['message-top.vue']},{demoId:'message-id',name:{'zh-CN':'防止重复消息提示','en-US':'Prevent Repeated Prompts'},desc:{'zh-CN':'通过<code>id</code>设置防止重复提示\u3002','en-US':'Prevent repeated prompts with the <code>id</code> setting.'},codeFiles:['message-id.vue']},{demoId:'message-event',name:{'zh-CN':'消息的事件','en-US':'messeage event'},desc:{'zh-CN':`
          当窗口显示时，会触发<code>show</code>事件<br />
          当窗口关闭时，会触发<code>hide</code>事件<br />
        `,'en-US':`
        ...
        `},codeFiles:['message-event.vue']}],features:[{id:'basic',name:'基本用法',support:{value:true},description:'通过 v-model 控制弹窗显示\uFF0Ctitle 设置标题\uFF0Ccontent 设置内容\u3002',cloud:{value:true},apis:['v-model','title','content'],demos:['basic-usage']},{id:'size',name:'尺寸',support:{value:true},description:'通过 size 设置弹窗大小\uFF0C可选值\uFF1Alarge\u3001medium\u3001small\u3001mini\u3002',cloud:{value:true},apis:['size'],demos:['size']},{id:'custom',name:'自定义内容',support:{value:true},description:'通过 default 插槽自定义弹窗内容\u3002',cloud:{value:true},apis:['slot-default'],demos:['custom-content']},{id:'header',name:'自定义头部',support:{value:true},description:'通过 header 插槽自定义弹窗头部\u3002',cloud:{value:true},apis:['slot-header'],demos:['custom-header']},{id:'footer',name:'自定义底部',support:{value:true},description:'通过 footer 插槽自定义弹窗底部\u3002',cloud:{value:true},apis:['slot-footer'],demos:['custom-footer']},{id:'close',name:'关闭按钮',support:{value:true},description:'通过 show-close 设置是否显示关闭按钮\uFF0Cclose-on-click-modal 设置点击遮罩层是否关闭\u3002',cloud:{value:true},apis:['show-close','close-on-click-modal'],demos:['close']},{id:'fullscreen',name:'全屏',support:{value:true},description:'通过 fullscreen 设置是否全屏显示\u3002',cloud:{value:true},apis:['fullscreen'],demos:['fullscreen']},{id:'events',name:'事件',support:{value:true},description:'支持 open\u3001close\u3001confirm\u3001cancel 等事件\u3002',cloud:{value:true},apis:['open','close','confirm','cancel'],demos:['events']}]};