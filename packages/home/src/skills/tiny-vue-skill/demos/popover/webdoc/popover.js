export default{column:'2',owner:'',show:true,cloud:true,demos:[{demoId:'basic-usage',name:{'zh-CN':'基本用法','en-US':'Basic Usage'},desc:{'zh-CN':`
          ...
          `},codeFiles:['basic-usage.vue']},{demoId:'trigger',name:{'zh-CN':'触发方式','en-US':'Trigger Mode'},desc:{'zh-CN':`
          ...
          `},codeFiles:['trigger.vue']},{demoId:'content',name:{'zh-CN':'弹出层内容','en-US':'Pop-up layer content'},desc:{'zh-CN':`
          ...
          `},codeFiles:['content.vue']},{demoId:'disabled',name:{'zh-CN':'禁用','en-US':'Disabled'},desc:{'zh-CN':'<code>disabled</code> 设置是否禁用弹出框\u3002','en-US':'<code>disabled</code> Specifies whether to disable the pop-up. '},codeFiles:['disabled.vue']},{demoId:'offset',name:{'zh-CN':'自定义偏移','en-US':'Custom Offset'},desc:{'zh-CN':`
          ...
          `},codeFiles:['offset.vue']},{demoId:'custom-popper',name:{'zh-CN':'自定义弹出面板','en-US':'Customize the pop-up panel'},desc:{'zh-CN':`
          ...
          `},codeFiles:['custom-popper.vue']},{demoId:'delay',name:{'zh-CN':'延迟控制','en-US':'Delay control'},desc:{'zh-CN':`
          ...
          `},codeFiles:['delay.vue']},{demoId:'transition',name:{'zh-CN':'自定义渐变动画','en-US':'Customized Gradient Animation'},desc:{'zh-CN':'通过 <code>transition</code> 设置弹框的显示隐藏淡入淡出动画\uFF0C默认取值 <code>fade-in-linear</code> \u3002','en-US':'You can run the <code>transition</code> command to set the display hidden fade in and fade out animation of a pop-up. The default value is fade-in-linear.'},codeFiles:['transition.vue']},{demoId:'popper-options',name:{'zh-CN':'高级选项','en-US':'Pop-up Options'},desc:{'zh-CN':'通过<code>popper-options</code> 配置弹出框高级选项\u3002','en-US':'Run the <code>popper-options</code> command to configure the advanced pop-up options. For details, see the IPopperOption description at the bottom'},codeFiles:['popper-options.vue']},{demoId:'ignore-boundaries',name:{'zh-CN':'忽略边界判断','en-US':'Ignore boundary judgment'},desc:{'zh-CN':`
        ...
        `,'en-US':`
          ...
          `},codeFiles:['ignore-boundaries.vue']},{demoId:'events',name:{'zh-CN':'事件','en-US':'Event'},desc:{'zh-CN':`
          组件支持以下事件：<br>
          <code>hide</code> 隐藏时触发回调；<br>
          <code>show</code> 显示时触发回调；<br>
          <code>after-leave</code> 进入的动画结束后触发回调；<br>
          <code>after-enter</code> 离开的动画播结束后触发回调；<br>`,'en-US':`
